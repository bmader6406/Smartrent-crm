App.Views.UserNewOrUpdate = Backbone.View.extend({
  ...
  user: function(){
    return this.model !== undefined ? this.model.toJSON() : new App.Models.User().toJSON();
  },
      ...
      if (result) {
        self.model.destroy({
          success: function(model, response) {
            ...
            App.routerInst.navigate(App.vars.usersPath, true);
            App.hideMask();
          },
  ...
  hideForm: function(){
    if(this.isCreateNew){
      ...
      App.routerInst.navigate(App.vars.accountsPath, true);
      
    } else {
      App.routerInst.navigate(App.vars.accountsPath + "/" + this.model.get('id'), true);
    }
  },
